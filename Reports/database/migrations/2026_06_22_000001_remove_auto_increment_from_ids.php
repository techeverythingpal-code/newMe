...
return new class extends Migration
{
    public function up(): void
    {
        if (DB::connection()->getDriverName() === 'pgsql') {
            ...
            // MySQL: drop AUTO_INCREMENT while keeping the columns as primary keys
            DB::statement('ALTER TABLE super_visors MODIFY SuperVisor_id BIGINT UNSIGNED NOT NULL');
            DB::statement('ALTER TABLE teacher_infos MODIFY id INT UNSIGNED NOT NULL');
            DB::statement('ALTER TABLE teacher_grades MODIFY id INT UNSIGNED NOT NULL');
        }
    }
    ...
    public function down(): void
    {
        if (DB::connection()->getDriverName() === 'pgsql') {
            ...
            DB::statement('ALTER TABLE super_visors MODIFY SuperVisor_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT');
            DB::statement('ALTER TABLE teacher_infos MODIFY id INT UNSIGNED NOT NULL AUTO_INCREMENT');
            DB::statement('ALTER TABLE teacher_grades MODIFY id INT UNSIGNED NOT NULL AUTO_INCREMENT');
        }
    }
};