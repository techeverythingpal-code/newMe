<nav x-data="{ open: false }" class="bg-white border-b border-gray-100" dir="rtl">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="font-bold text-xl text-indigo-600">
                        نظام تقارير المعلمين
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-reverse space-x-6 sm:-my-px sm:me-10 sm:flex">
                    ...
                    @if(Auth::guard('admin')->check())
                        {{-- Admin menu --}}
                        <x-nav-link :href="route('directorates.index')" :active="request()->routeIs('directorates.*')">
                            المديريات
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::guard('admin')->check())
                <x-responsive-nav-link :href="route('directorates.index')" :active="request()->routeIs('directorates.*')">
                    المديريات
                </x-responsive-nav-link>
